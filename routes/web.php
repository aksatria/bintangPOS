...
Route::middleware(['auth', 'branch.access'])->group(function () {
    ...
    Route::middleware('role:owner,admin')->group(function () {
        ...
        Route::get('/admin/suppliers', [SupplierManagementController::class, 'index'])->middleware('permission:suppliers.manage')->name('admin.suppliers.index');
        Route::post('/admin/suppliers', [SupplierManagementController::class, 'suppliersStore'])->middleware('permission:suppliers.manage')->name('admin.suppliers.store');
        Route::get('/admin/suppliers/{supplier}', [SupplierManagementController::class, 'suppliersShow'])->middleware('permission:suppliers.manage')->name('admin.suppliers.show');
        Route::put('/admin/suppliers/{supplier}', [SupplierManagementController::class, 'suppliersUpdate'])->middleware('permission:suppliers.manage')->name('admin.suppliers.update');
        Route::delete('/admin/suppliers/{supplier}', [SupplierManagementController::class, 'suppliersDestroy'])->middleware('permission:suppliers.manage')->name('admin.suppliers.destroy');
        Route::get('/admin/supplier-debts', [SupplierManagementController::class, 'supplierDebtsReport'])->middleware('permission:suppliers.manage')->name('admin.supplier-debts.index');
        Route::get('/admin/supplier-debts/export/excel', [SupplierManagementController::class, 'supplierDebtsExportExcel'])->middleware('permission:suppliers.manage')->name('admin.supplier-debts.export.excel');
        Route::get('/admin/supplier-debts/export/pdf', [SupplierManagementController::class, 'supplierDebtsExportPdf'])->middleware('permission:suppliers.manage')->name('admin.supplier-debts.export.pdf');
        Route::get('/admin/accounting/journals', [AccountingController::class, 'journals'])->middleware('permission:suppliers.manage')->name('admin.accounting.journals');
        Route::get('/admin/accounting/ledger', [AccountingController::class, 'ledger'])->middleware('permission:suppliers.manage')->name('admin.accounting.ledger');
        Route::get('/admin/accounting/reports', [AccountingController::class, 'reports'])->middleware('permission:suppliers.manage')->name('admin.accounting.reports');
        Route::post('/admin/supplier-purchases', [SupplierManagementController::class, 'purchasesStore'])->middleware('permission:suppliers.manage')->name('admin.supplier-purchases.store');
        Route::get('/admin/supplier-purchases-export/excel', [SupplierManagementController::class, 'purchasesExportExcel'])->middleware('permission:suppliers.manage')->name('admin.supplier-purchases.export.excel');
        Route::get('/admin/supplier-purchases/{purchase}', [SupplierManagementController::class, 'purchasesShow'])->middleware('permission:suppliers.manage')->name('admin.supplier-purchases.show');
        Route::put('/admin/supplier-purchases/{purchase}', [SupplierManagementController::class, 'purchasesUpdate'])->middleware('permission:suppliers.manage')->name('admin.supplier-purchases.update');
        Route::post('/admin/supplier-purchases/{purchase}/attachments', [SupplierManagementController::class, 'purchasesAttachmentStore'])->middleware('permission:suppliers.manage')->name('admin.supplier-purchases.attachments.store');
        Route::get('/admin/supplier-purchase-attachments/{attachment}/download', [SupplierManagementController::class, 'purchasesAttachmentDownload'])->middleware('permission:suppliers.manage')->name('admin.supplier-purchase-attachments.download');
        Route::delete('/admin/supplier-purchase-attachments/{attachment}', [SupplierManagementController::class, 'purchasesAttachmentDestroy'])->middleware('permission:suppliers.manage')->name('admin.supplier-purchase-attachments.destroy');
        Route::post('/admin/supplier-purchase-payments/{payment}/proof', [SupplierManagementController::class, 'purchasesPaymentProofStore'])->middleware('permission:suppliers.manage')->name('admin.supplier-purchase-payments.proof.store');
        Route::post('/admin/supplier-purchases/{purchase}/duplicate', [SupplierManagementController::class, 'purchasesDuplicate'])->middleware('permission:suppliers.manage')->name('admin.supplier-purchases.duplicate');
        Route::post('/admin/supplier-purchases/{purchase}/request-approval', [SupplierManagementController::class, 'purchasesRequestApproval'])->middleware('permission:suppliers.manage')->name('admin.supplier-purchases.request-approval');
        Route::post('/admin/supplier-purchases/{purchase}/cancel', [SupplierManagementController::class, 'purchasesCancel'])->middleware('permission:suppliers.manage')->name('admin.supplier-purchases.cancel');
        Route::get('/admin/supplier-purchases/{purchase}/pdf', [SupplierManagementController::class, 'purchasesPdf'])->middleware('permission:suppliers.manage')->name('admin.supplier-purchases.pdf');
        Route::get('/admin/supplier-purchases/{purchase}/returns/pdf', [SupplierManagementController::class, 'purchasesReturnsPdf'])->middleware('permission:suppliers.manage')->name('admin.supplier-purchases.returns.pdf');
        Route::post('/admin/supplier-purchases/{purchase}/reconcile', [SupplierManagementController::class, 'purchasesReconcile'])->middleware('permission:suppliers.manage')->name('admin.supplier-purchases.reconcile');
        Route::post('/admin/supplier-purchases/{purchase}/receive', [SupplierManagementController::class, 'purchasesReceive'])->middleware('permission:suppliers.manage')->name('admin.supplier-purchases.receive');
        Route::post('/admin/supplier-purchases/{purchase}/receive-partial', [SupplierManagementController::class, 'purchasesReceivePartial'])->middleware('permission:suppliers.manage')->name('admin.supplier-purchases.receive-partial');
        Route::post('/admin/supplier-purchases/{purchase}/returns', [SupplierManagementController::class, 'purchasesReturnStore'])->middleware('permission:suppliers.manage')->name('admin.supplier-purchases.returns.store');
        Route::post('/admin/supplier-purchases/{purchase}/pay', [SupplierManagementController::class, 'purchasesPay'])->middleware('permission:suppliers.manage')->name('admin.supplier-purchases.pay');
        ...
        Route::get('/customers/debts', [CustomerDebtController::class, 'index'])->middleware('permission:customers.debt.manage')->name('customers.debts.index');
        Route::get('/customers/debts/export/csv', [CustomerDebtController::class, 'exportCsv'])->middleware('permission:customers.debt.manage')->name('customers.debts.export.csv');
        Route::get('/customers/debts/export/excel', [CustomerDebtController::class, 'exportExcel'])->middleware('permission:customers.debt.manage')->name('customers.debts.export.excel');
        Route::post('/customers/debts', [CustomerDebtController::class, 'store'])->middleware('permission:customers.debt.manage')->name('customers.debts.store');
        Route::post('/customers/debts/{debt}/pay', [CustomerDebtController::class, 'pay'])->middleware('permission:customers.debt.manage')->name('customers.debts.pay');
        Route::post('/customers/{customer}/debts/pay-fifo', [CustomerDebtController::class, 'payCustomerFifo'])->middleware('permission:customers.debt.manage')->name('customers.debts.pay-fifo');
