<x-app-layout>
    ...
    <x-slot name="header">
        <div class="flex flex-wrap items-center justify-between gap-3">
            <div>
                ...
                <h2 class="text-2xl font-extrabold tracking-tight text-slate-900">Laporan Penjualan</h2>
            </div>
        </div>
    </x-slot>
    ...
    <div class="page-shell report-shell space-y-6 {{ !empty($compact) ? 'report-shell--compact' : '' }}">
        ...
        @endif
        <form method="GET" action="{{ route('reports.index') }}" class="panel-card report-filter-card report-filter-card--sticky-mobile" id="report-filter-form">
    ...
    <style>
        .report-filter-card--sticky-mobile {
            position: sticky;
            top: .5rem;
            z-index: 20;
            backdrop-filter: blur(4px);
        }
        .report-filter-grid--responsive {
            display: grid;
            grid-template-columns: repeat(1, minmax(0, 1fr));
            gap: .75rem;
        }
        .report-filter-col .input-ui {
            width: 100%;
        }
        .report-filter-actions--responsive {
            display: flex;
            flex-wrap: wrap;
            gap: .5rem;
        }
        .report-filter-actions--responsive .report-btn {
            width: 100%;
        ...
        @media (min-width: 768px) {
            ...
            .report-approval-grid > div:first-child {
                grid-column: span 2 / span 2;
            }
        }
        .report-mobile-actionbar-meta {
            display: flex;
            align-items: center;
        ...
        .report-mobile-actionbar-actions {
            display: grid;
            grid-template-columns: repeat(3, minmax(0, 1fr));
            gap: .4rem;
        }
        .report-mobile-actionbar-actions .report-btn {
            width: 100%;
            justify-content: center;
            padding-left: .2rem;
            padding-right: .2rem;
        ...
        .report-table--transactions-mobile {
            min-width: 980px;
        }
        .report-mobile-cards {
            display: grid;
        ...
        .report-mobile-meta { color: #475569; font-size: .8rem; margin-top: .28rem; line-height: 1.4; }
        .report-mobile-qris {
            margin-top: .55rem;
            display: flex;
            align-items: center;
        ...
        .report-mobile-detail-title {
            font-size: .75rem;
            font-weight: 800;
            color: #0f172a;
            margin-bottom: .35rem;
        }
        .report-mobile-detail-row {
            display: flex;
        ...
        .report-mini-label { color: #64748b; font-size: .74rem; text-transform: uppercase; letter-spacing: .04em; }
        .report-mini-value { color: #0b1324; font-size: 1.08rem; font-weight: 800; margin-top: .15rem; }
        .report-loading-skeleton { padding: .9rem; }
        .report-skeleton-line {
            ...
            animation: reportShimmer 1.1s ease-in-out infinite;
        }
        .report-empty-state {
        ...
        .report-empty-title { color: #0f172a; font-weight: 700; }
        .report-empty-note { color: #64748b; font-size: .85rem; margin: .25rem 0 .65rem; }
        @keyframes reportShimmer {
            0% { background-position: 100% 0; }
            100% { background-position: 0 0; }
        }
        .report-qris-ref-cell {
            word-break: break-all;
            white-space: normal;
        }
        .report-table--transactions th,
        .report-table--transactions td {
            text-align: left !important;
            vertical-align: middle;
        }
        .report-table--transactions .report-total-cell,
        .report-table--transactions .report-cell-title,
        .report-table--transactions .report-cell-sub {
            text-align: left !important;
        }
        .report-table--cashier-payment th,
        .report-table--cashier-payment td {
            text-align: left !important;
            vertical-align: middle;
        }
        .report-table--cashier-payment td {
