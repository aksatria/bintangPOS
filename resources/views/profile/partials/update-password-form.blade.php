<section>
    <header>
        <h2 class="text-xl font-bold text-slate-900">Ubah Password</h2>
        <p class="mt-2 text-sm text-slate-500">Gunakan password yang kuat untuk menjaga keamanan akun.</p>
    </header>
