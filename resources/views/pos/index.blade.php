    ...
    <x-slot name="header">
        <div class="flex flex-wrap items-center justify-between gap-3">
            <div>
                ...
                <h2 class="text-2xl font-extrabold tracking-tight text-slate-900">Kasir</h2>
            </div>
            <p class="text-sm text-slate-500">Cari produk, tambah ke keranjang, lalu checkout.</p>
        </div>
    </x-slot>

    <style>
        .pos-success-modal-backdrop {
            position: fixed;
            inset: 0;
            z-index: 90;
        ...
        .pos-success-modal {
            --pos-accent-50: #eff6ff;
            --pos-accent-100: #dbeafe;
            --pos-accent-500: #3b82f6;
            --pos-accent-700: #1d4ed8;
            width: min(100%, 30rem);
            border-radius: 16px;
            background: #ffffff;
        ...
        .pos-modal-btn--primary {
            background: linear-gradient(135deg, var(--pos-accent-500), var(--pos-accent-700));
            color: #fff;
            box-shadow: 0 8px 18px color-mix(in srgb, var(--pos-accent-500) 45%, transparent);
        }
        ...
        .pos-confirm-summary {
            margin-top: 0.9rem;
            border: 1px solid var(--pos-accent-100);
            background: linear-gradient(180deg, color-mix(in srgb, var(--pos-accent-50) 70%, #ffffff), #f8fafc);
            border-radius: 12px;
            padding: 0.75rem;
        }
        .pos-confirm-summary-grid {
            display: grid;
        ...
        .pos-confirm-item--total {
            grid-column: 1 / -1;
            border-color: color-mix(in srgb, var(--pos-accent-500) 45%, #cbd5e1);
            background: linear-gradient(135deg, color-mix(in srgb, var(--pos-accent-50) 75%, #ffffff), #ffffff);
            box-shadow: inset 0 0 0 1px color-mix(in srgb, var(--pos-accent-100) 55%, transparent);
            padding: 0.7rem 0.75rem;
        }
        .pos-confirm-item-label {
            font-size: 0.7rem;
        ...
        .pos-confirm-item-value {
            margin-top: 0.2rem;
            font-size: 0.92rem;
            color: #0f172a;
            font-weight: 800;
        }
        .pos-confirm-item--total .pos-confirm-item-label {
            color: color-mix(in srgb, var(--pos-accent-700) 75%, #334155);
        }
        .pos-confirm-item--total .pos-confirm-item-value {
            margin-top: 0.1rem;
            font-size: 1.35rem;
            line-height: 1.15;
            letter-spacing: 0.01em;
            color: color-mix(in srgb, var(--pos-accent-700) 85%, #0f172a);
        }
        .pos-confirm-status {
            margin-top: 0.6rem;
            display: inline-flex;
            align-items: center;
            gap: 0.45rem;
            background: color-mix(in srgb, var(--pos-accent-100) 70%, #e2e8f0);
            border-radius: 999px;
        ...
        .pos-confirm-status-dot {
            width: 0.42rem;
            height: 0.42rem;
            border-radius: 999px;
            background: var(--pos-accent-500);
        }
        .pos-success-modal--info {
            --pos-accent-50: #eff6ff;
            --pos-accent-100: #dbeafe;
            --pos-accent-500: #3b82f6;
            --pos-accent-700: #1d4ed8;
        }
        .pos-success-modal--success {
            --pos-accent-50: #ecfdf5;
            --pos-accent-100: #d1fae5;
            --pos-accent-500: #10b981;
            --pos-accent-700: #047857;
        }
        .pos-success-modal--warning {
            --pos-accent-50: #fffbeb;
            --pos-accent-100: #fde68a;
            --pos-accent-500: #f59e0b;
            --pos-accent-700: #b45309;
        }
        .pos-success-modal--danger {
            --pos-accent-50: #fef2f2;
            --pos-accent-100: #fecaca;
            --pos-accent-500: #ef4444;
            --pos-accent-700: #b91c1c;
        }
    </style>
