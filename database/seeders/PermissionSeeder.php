...
class PermissionSeeder extends Seeder
{
    public function run(): void
    {
        $permissionDefinitions = [
            ...
            ['code' => 'customers.debt.manage', 'name' => 'Kelola Hutang Pelanggan', 'group' => 'customers'],
            ...
            ['code' => 'stock-transfer.view', 'name' => 'Lihat Mutasi Stok', 'group' => 'stock-transfer'],
            ['code' => 'stock-transfer.request', 'name' => 'Buat Request Mutasi Stok', 'group' => 'stock-transfer'],
            ['code' => 'stock-transfer.approve', 'name' => 'Approve/Reject Mutasi Stok', 'group' => 'stock-transfer'],
            ['code' => 'stock-transfer.receive', 'name' => 'Receive Mutasi Stok', 'group' => 'stock-transfer'],
            ['code' => 'stock-transfer.export', 'name' => 'Export Dokumen Mutasi Stok', 'group' => 'stock-transfer'],
            ['code' => 'audit-logs.view', 'name' => 'Lihat Audit Log', 'group' => 'audit'],
            ['code' => 'master-data.manage', 'name' => 'Kelola Master Data', 'group' => 'master-data'],
            ['code' => 'suppliers.manage', 'name' => 'Kelola Supplier & Pembelian', 'group' => 'master-data'],
